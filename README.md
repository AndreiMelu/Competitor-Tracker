...
We could expand each competitor's profile to include their pricing, their key product, weaknesses, etc. 
Reps would have everything they need in one place.

2. Reports and dashboards for steakholders/leadership
Data is now structured in Salesforce, so it can be reported like:
